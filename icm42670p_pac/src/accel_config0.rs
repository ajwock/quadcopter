...
use crate::Icm42670P;
pub struct AccelConfig0<'a, D: embedded_hal_async::delay::DelayNs, C: RegComms<1, u8>>(pub &'a mut Icm42670P<D, C>);
impl<'a, D: embedded_hal_async::delay::DelayNs, C: RegComms<1, u8>> AccelConfig0<'a, D, C> {
