...
pub static CURRENT_Y: AtomicI32 = AtomicI32::new(0);
pub static CURRENT_Z: AtomicI32 = AtomicI32::new(0);

pub static CONTROLLER_CONNECTED: Signal<CriticalSectionRawMutex, ()> = Signal::new();
pub static CONTROLLER_DISCONNECTED: AtomicBool = AtomicBool::new(false);
